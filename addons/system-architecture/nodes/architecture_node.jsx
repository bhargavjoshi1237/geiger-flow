...
const handleClass =
  "!h-2.5 !w-2.5 !border !border-border-strong !bg-background transition-colors";
...
export function ArchitectureNode({ data, selected }) {
  ...
  return (
    <div
      className={cn(
        "group relative w-[230px] rounded-lg border bg-surface-card p-3 text-foreground shadow-2xl transition-colors",
        selected ? "border-border-strong" : "border-border hover:border-border",
      )}
    ...
    >
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-0.5 truncate text-[11px] font-medium uppercase tracking-[0.08em] text-text-secondary">
      ...
      {data.meta ? (
        <div className="mt-3 flex items-center justify-between border-t border-border pt-2 text-[11px] text-text-secondary">
