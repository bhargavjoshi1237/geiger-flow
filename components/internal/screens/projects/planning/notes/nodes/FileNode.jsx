...
const FileNode = ({ id, data, selected, dragging }) => {
  ...
  const color = data.color || "var(--node-default)";
      ...
      >
        ...
        <div className="flex flex-col h-full w-full">
          <div className="flex items-center p-4 gap-3">
            <div className="w-10 h-10 rounded-none bg-surface-card/50 flex items-center justify-center shrink-0">
            ...
            {fileUrl && (
              <Button
                ...
                className="p-2 hover:bg-surface-card/50 rounded-none transition-colors text-muted-foreground hover:text-foreground z-10"
                title="Download"
              >
                <Download size={16} />
              </Button>
