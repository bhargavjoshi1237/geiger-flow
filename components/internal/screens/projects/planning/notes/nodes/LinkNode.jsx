    ...
    <>
      ...
      >
        ...
        <div className="flex-1 w-full h-full overflow-hidden flex items-center px-4">
          <Link className="w-5 h-5 text-text-secondary mr-3 flex-shrink-0" />
          <TextEditingTrait className="w-full">
            <Input
              className="w-full border-0 bg-transparent px-0 py-0 text-foreground shadow-none placeholder:text-text-tertiary focus-visible:ring-0 font-sans"
