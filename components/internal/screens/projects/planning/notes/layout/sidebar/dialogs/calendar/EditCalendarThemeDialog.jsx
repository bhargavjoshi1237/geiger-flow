  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <div className="p-4 bg-surface-dialog h-[300px] overflow-y-auto scrollbar-thin scrollbar-thumb-zinc-800">
          <div className="mb-4">
            <div
          ...
          <div className="mb-4">
            <span className="text-[10px] text-text-secondary uppercase tracking-wider mb-2 block">
              Theme
            </span>
            <div className="grid grid-cols-2 gap-2">
              <Button
                ...
                className={cn(
                  ...
                  activeTheme === "light"
                    ? "border-foreground text-foreground bg-surface-card/50"
                    : "border-border text-text-secondary hover:text-foreground hover:bg-surface-card/30"
                )}
              >
