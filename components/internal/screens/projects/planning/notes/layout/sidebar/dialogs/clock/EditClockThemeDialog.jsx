...
const ColorField = ({ label, value, onChange }) => (
  <div className="flex items-center justify-between py-1.5 group/color">
    ...
    <ColorPicker value={value} onChange={onChange} align="center">
      <Button
        className="w-8 h-5 rounded-[5px] border border-border-strong/80 cursor-pointer hover:border-muted-foreground transition-all hover:scale-110 focus:outline-none focus:ring-1 focus:ring-ring focus:ring-offset-1 focus:ring-offset-background"
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader className="p-4 border-b border-border space-y-0">
          <div className="flex items-center justify-between w-full">
            ...
            <Button
              ...
              className="w-7 h-7 rounded-lg flex items-center justify-center text-text-secondary hover:text-foreground hover:bg-surface-card transition-all"
            >
              <X className="w-4 h-4" />
            </Button>
          </div>
        ...
        <div className="p-4 bg-surface-dialog h-[450px] overflow-y-auto scrollbar-thin scrollbar-thumb-zinc-800">
          <div className="mb-2">
            <div
              className="rounded-xl border border-border/60 bg-surface-card p-5 flex items-center justify-center h-[180px]"
              style={{
                backgroundImage:
          ...
          <div>
            <div className="rounded-lg border border-border/60 bg-surface-card px-3.5 py-2">
              {activeTab === "analog" ? (
