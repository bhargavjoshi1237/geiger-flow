...
export function UsageScreen() {
  return (
    <MainScreenWrapper className="flex flex-col gap-8 space-y-0 text-foreground">
      <ScreenHeader
        title="Usage"
        description="Resource consumption across every project in this workspace."
        actions={
          <>
            <div className="flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
              ...
              <div className="flex items-center gap-2 whitespace-nowrap">
                ...
                <span className="text-xs font-medium text-foreground">0d / 0d</span>
                <span className="text-xs text-muted-foreground">0%</span>
              </div>
            </div>
            <Select defaultValue="billing">
              <SelectTrigger className="h-8 w-full border-border bg-surface-card text-xs text-muted-foreground sm:w-[180px]">
