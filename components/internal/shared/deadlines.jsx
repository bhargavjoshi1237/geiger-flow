  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between px-1">
        ...
        <button className="text-xs font-medium text-muted-foreground hover:text-foreground px-3 py-1.5 rounded-lg transition-colors hover:border-ring flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {deadlines.map((deadline) => (
          <Card
            key={deadline.id}
            className="bg-card border hover:border-ring transition-colors flex flex-col justify-between py-0 gap-0"
          >
            ...
            <CardContent className="p-5 pt-4 space-y-3">
              ...
              <div className="w-full h-1 bg-background rounded-full mt-4 overflow-hidden border">
                <div
            ...
            <CardFooter className="p-5 pt-4 border-t flex items-center justify-between">
